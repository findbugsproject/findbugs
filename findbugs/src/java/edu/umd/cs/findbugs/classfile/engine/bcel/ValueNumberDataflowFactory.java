...
public class ValueNumberDataflowFactory extends DataflowAnalysisFactory<ValueNumberDataflow> {
...
//    @Override
//    protected ValueNumberDataflow analyze(JavaClass jclass, Method method) throws DataflowAnalysisException, CFGBuilderException {
...
//    	LoadedFieldSet loadedFieldSet = getLoadedFieldSet(jclass, method);
//    	ValueNumberAnalysis analysis = new ValueNumberAnalysis(methodGen, dfs, loadedFieldSet,
//    			AnalysisContext.currentAnalysisContext().getLookupFailureCallback());
//    	analysis.setMergeTree(new MergeTree(analysis.getFactory()));
