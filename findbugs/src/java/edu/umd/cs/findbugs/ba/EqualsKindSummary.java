...
public class EqualsKindSummary {
	...
	final Map<IClassAnnotation, EqualsKindSummary.KindOfEquals> kindMap = new HashMap<IClassAnnotation, EqualsKindSummary.KindOfEquals>();
	...
	public EqualsKindSummary.KindOfEquals get(IClassAnnotation c) {
		return kindMap.get(c);
	}
	public  void put(IClassAnnotation c, EqualsKindSummary.KindOfEquals k) {
		 kindMap.put(c, k);
	}
}
