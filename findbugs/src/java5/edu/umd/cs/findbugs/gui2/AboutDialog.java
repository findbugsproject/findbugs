...
public class AboutDialog extends javax.swing.JDialog {
	...
	public AboutDialog(JFrame parent, Logger l, boolean modal) {
		...
		setTitle(MessageFormat.format(edu.umd.cs.findbugs.gui2.L10N.getLocalString("dlg.aboutfindbugs_ttl", "About FindBugs {0}"), new Object[]{Version.RELEASE}));
	}
	...
	private void processPage(javax.swing.JEditorPane pane, String fileName) throws IOException {
		...
		try {
			...
			if (in == null)
				throw new IOException(MessageFormat.format(edu.umd.cs.findbugs.gui2.L10N.getLocalString("msg.couldntload_txt", "Couldn't load {0}"), new Object[]{fileName}));
	...
	private void initComponents() {//GEN-BEGIN:initComponents
		...
		{
			aboutTabPane.setTitleAt(0, edu.umd.cs.findbugs.gui2.L10N.getLocalString("dlg.about_tab", "About"));
			aboutTabPane.setTitleAt(1, edu.umd.cs.findbugs.gui2.L10N.getLocalString("dlg.license_tab", "License"));
			aboutTabPane.setTitleAt(2, edu.umd.cs.findbugs.gui2.L10N.getLocalString("dlg.acknowledgements_tab", "Acknowledgements"));
		}
		gridBagConstraints = new java.awt.GridBagConstraints();
		...
		okButton.setText(edu.umd.cs.findbugs.gui2.L10N.getLocalString("dlg.ok_btn", "OK"));
