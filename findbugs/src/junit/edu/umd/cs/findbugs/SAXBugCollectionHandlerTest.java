    ...
    public void testBugInstanceXmlPropsNoReviews() throws Exception {
        ...
        bc.readXML(new StringReader(
                "<BugCollection version='1.3.10-dev-20100728' sequence='0' timestamp='1280333223462' analysisTimestamp='1280333224881' release=''>"
                        ...
                        + "    <LongMessage>org.apache.commons.bcel6.Constants.ACCESS_NAMES is a mutable array</LongMessage>"
                        + "    <Class classname='org.apache.commons.bcel6.Constants' primary='true'>"
                        + "      <SourceLine classname='org.apache.commons.bcel6.Constants' start='210' end='1443' sourcefile='Constants.java' sourcepath='org/apache/bcel/Constants.java'>"
                        + "        <Message>At Constants.java:[lines 210-1443]</Message>"
                        + "      </SourceLine>"
                        + "      <Message>In class org.apache.commons.bcel6.Constants</Message>"
                        + "    </Class>"
                        + "    <Field classname='org.apache.commons.bcel6.Constants' name='ACCESS_NAMES' signature='[Ljava/lang/String;' isStatic='true' primary='true'>"
                        + "      <SourceLine classname='org.apache.commons.bcel6.Constants' sourcefile='Constants.java' sourcepath='org/apache/bcel/Constants.java'>"
                        + "        <Message>In Constants.java</Message>"
                        + "      </SourceLine>"
                        + "      <Message>Field org.apache.commons.bcel6.Constants.ACCESS_NAMES</Message>"
                        + "    </Field>"
                        + "    <SourceLine classname='org.apache.commons.bcel6.Constants' primary='true' start='210' end='210' startBytecode='89' endBytecode='89' sourcefile='Constants.java' sourcepath='org/apache/bcel/Constants.java'>"
